...
@media (max-width: 768px) {
  ...
  #test img.special-quote-image {
    max-width: 80vw !important;
    height: auto !important;
    margin: 0 auto 10px auto !important;
  }
  #test .special-quote-text {
...
<!-- Paste all your sections here exactly as you had them -->
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Update emoji based on current_score (not overall_score)
    ...
    const profileCurrentScore = document.getElementById('profile-current-score');
    ...
    // Extract the numeric score from the text content (e.g., "Current: 5")
    const scoreText = profileCurrentScore.textContent;
    const scoreMatch = scoreText.match(/Current:\s*(\d+)/);
